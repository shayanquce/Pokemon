...
const LUMINARY_SPECIES = {
  ...
  embrath: {
    ...
    evolution: { toId: 'embralion', to: 'Embralion', level: 34 },
  ...
  tidarune: {
    ...
    evolution: { toId: 'runedeep', to: 'Runedeep', level: 32 },
  ...
  thorngrove: {
    ...
    evolution: { toId: 'grovemaw', to: 'Grovemaw', level: 33 },
  ...
  // --- Starter third stages (Lv 32-34, the Cinderpeaks curve) ---
  embralion: {
    id: 'embralion', dexNo: 3, name: 'Embralion', types: ['Flame', 'Light'],
    baseStats: { hp: 76, atk: 94, def: 70, spa: 92, spd: 74, spe: 96 },
    tagline: 'The hearth grew a heart. The heart grew a dawn.',
    lore: 'When an Embrath has kept its promise through every dark its human walked into, the flame stops burning OF something and simply burns. An Embralion casts no shadow — there is nowhere on it for one to start.',
    captureRate: 45, baseExp: 240,
    signatureMove: 'cindershroud',
    learnset: [{ id: 'cinder_snap', level: 1 }, { id: 'tail_glimmer', level: 1 }, { id: 'flame_burst', level: 9 }, { id: 'magma_lash', level: 34 }, { id: 'dawn_lance', level: 37 }],
  },
  runedeep: {
    id: 'runedeep', dexNo: 6, name: 'Runedeep', types: ['Tide', 'Psyche'],
    baseStats: { hp: 88, atk: 64, def: 82, spa: 100, spd: 90, spe: 58 },
    tagline: 'The glyphs stopped spelling the tide. They started writing it.',
    lore: 'A Runedeep remembers the trench it rose from, and the trench remembers back. Its mantle-script now finishes sentences the Aethori never got to — sailors no longer read it for weather, but for advice.',
    captureRate: 45, baseExp: 240,
    signatureMove: 'lanternveil',
    learnset: [{ id: 'drip_lash', level: 1 }, { id: 'glowpulse', level: 1 }, { id: 'brine_jet', level: 9 }, { id: 'riptide_maw', level: 32 }, { id: 'dawn_lance', level: 36 }],
  },
  grovemaw: {
    id: 'grovemaw', dexNo: 9, name: 'Grovemaw', types: ['Verdant', 'Stone'],
    baseStats: { hp: 104, atk: 96, def: 92, spa: 50, spd: 72, spe: 44 },
    tagline: 'The forest stopped walking. The mountain started.',
    lore: 'A Grovemaw\'s roots finally found bedrock and shook hands with it. It moves four times a year, on principle, and entire trails redraw themselves politely around the decision.',
    captureRate: 45, baseExp: 240,
    signatureMove: 'bramblefort',
    learnset: [{ id: 'briar_swipe', level: 1 }, { id: 'rootbrace', level: 1 }, { id: 'thorn_volley', level: 9 }, { id: 'pebble_toss', level: 33 }, { id: 'hoof_rush', level: 36 }],
  },
  spriggrove: {
